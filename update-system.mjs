...
// out of the checkout, staging and scoped commit with it.
 ...
 * Exact exclusion pathspecs may accompany those files; they are resolved here
 * before `--literal-pathspecs` makes Git treat every remaining entry as a name.
 *
